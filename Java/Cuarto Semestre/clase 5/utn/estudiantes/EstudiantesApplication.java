	...
	private boolean ejecutarOpciones(Scanner consola) {
		...
		switch (opcion) {
			...
			case 2 ->{//Buscar estudiante por id
				logger.info("Digite el estudiante a buscar");
			...
			case 4 ->{//modificar estudiante
				...
				var idEstudiante = Integer.parseInt(consola.nextLine());
				//buscamos el id estudiante a modificar
				...
				if(estudiante != null){
					...
					estudiante.setEmail(email);
					estudianteServicio.guardarEstudiante(estudiante);
					logger.info("El estudiante modificado: "+ estudiante+nl);
				}
				else
			...
			case 5 ->{//eliminar estudiante
				...
				logger.info("Digite el id del estudinate: ");
				var idEstudiante = Integer.parseInt(consola.nextLine());
				...
				if(estudiante !=null){
					...
					logger.info("Estudiante No encontrado con id: "+estudiante);
